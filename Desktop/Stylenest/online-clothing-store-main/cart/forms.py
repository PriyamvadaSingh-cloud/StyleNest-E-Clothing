...
class ShippingAddressForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if user_id:
            ...
            # email not required for authenticated users
            self.fields['email'].required = False
        else:
            # guest checkout: no saved addresses; require email
            self.fields['selected_shipping_address'].queryset = Address.objects.none()
            self.fields['selected_shipping_address'].empty_label = 'Select a shipping address'
